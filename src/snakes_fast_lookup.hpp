...
Snakes compute_all_snakes_seq(const std::vector<int> &in_1, const std::vector<int> &in_2, int k_min, int k_max)
{ // inclusive
    if (k_min > k_max)
    {
        // return empty Snakes
